      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-8 py-5 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <span className="text-gray-900 text-2xl font-bold tracking-tight">Buyonic</span>
          </div>
          ...
          <div className="flex-1 max-w-2xl mx-12">
            <div className="relative">
              ...
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-slate-600 hover:bg-slate-700 p-2.5 rounded-lg transition-all duration-300">
                <img src={SRCH} className="h-4 w-4 brightness-0 invert" alt="Search" />
              </button>
            </div>
          </div>
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex items-center gap-8 py-4">
        ...
        >
          ...
          <span className="text-gray-700 group-hover:text-slate-700 font-medium text-sm">Home</span>
        </div>
        ...
        <div className="group cursor-pointer flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-50 transition-all duration-300">
          ...
          <span className="text-gray-700 group-hover:text-slate-700 font-medium text-sm">Shop</span>
          <svg className="w-3 h-3 text-gray-400 group-hover:text-slate-600 transition-transform group-hover:rotate-180 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="group cursor-pointer flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-50 transition-all duration-300">
          ...
          <span className="text-gray-700 group-hover:text-slate-700 font-medium text-sm">Cart</span>
        </div>
        ...
        >
          ...
          <span className="text-gray-700 group-hover:text-slate-700 font-medium text-sm">Contact</span>
        </div>
      </div>
