    ...
    <div className="group rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition hover:border-gray-400 hover:shadow-md">
      ...
      <div className="mt-4 flex justify-center">
        <button
          ...
          className="w-4/5 rounded-2xl bg-slate-600 px-4 py-2 text-sm font-medium text-white active:scale-95 active:bg-slate-500 transition-transform duration-100 hover:opacity-95"
        >
          Add to cart
        </button>
      </div>
